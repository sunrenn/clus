...
function preload() {
  ...
  images[0] =
    loadImage('../assets/images/example_image_young_man_reading.jpg');
  // "Le Penseur", Auguste Rodin, 1880
  images[1] =loadImage('../assets/images/example_image_Thinking-Man.jpg');
  // "American Gothic", Grant DeVolson Wood, 1930
  images[2] = loadImage('../assets/images/example_image_American_Gothic.jpg');
  // "La Liseuse", Jean-Honoré Fragonard, 1770
  images[3] = loadImage('../assets/images/example_image_young_girl_reading.jpg');
}
